...
const projectData = [
  {
    ...
    srcURL: "https://carlisdev123.github.io/QR-Express",
  },
  {
    title: "Food Express",
    subTitle: "All Dishes",
    thumbnail: "../img/thumbnails/food-express.jpg",
    description:
      "Foood Express is a modern and user-friendly web application built with JavaScript. Food ordering frontend design",
    techStack: ["JavaScript", "HTML", "CSS"],
    srcURL: "https://carlisdev123.github.io/food-express/?#",
  },
  {
    title: "Exchange Rate Calculator",
    subTitle: "Gain insights and strengthen your GitHub connections",
    thumbnail: "../img/thumbnails/exchange.jpg",
    description:
    ...
    techStack: ["JavaScript", "HTML", "CSS"],
    srcURL: "https://carlisdev123.github.io/Exchange-rate-calculator/",
  },
    ...
    elem.innerHTML = buildTemplate(
      `<div class='projects-header'>
       ...
       <div class="card-buttons">
          <a href="https://github.com/Carlisdev123/" target="_blank" class="card-btn" style="float: right; height: 2.35rem; color: #fff; background-color: #68d372; padding: .375rem .75rem; border-radius: .25rem;"><i class="fa-regular fa-file-code"></i>Source Code</a>
...
async function getRepoList() {
  try {
    const response = await fetch(
      "https://api.github.com/users/Carlisdev123//repos"
    );
