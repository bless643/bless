...
$(document).ready(function () {
  ...
  const projectData = [
    ...
    },
    {
      ...
      srcURL: "https://bless643.github.io/food-express/?#",
    },
    {
      title: "Exchange Rate Calculator",
      subTitle: "Your Simple Currency Converter",
    ...
    },
    {
      ...
      techStack: ["JavaScript", "HTML", "CSS"],
      srcURL: "https://bless643.github.io/speed-scripter/",
    },
      ...
      elem.innerHTML = buildTemplate(
        `<div class='projects-header'>
         ...
         <div class="card-buttons">
            <a href="https://github.com/bless643/" target="_blank" class="card-btn" style="float: right; height: 2.35rem; color: #fff; background-color: #68d372; padding: .375rem .75rem; border-radius: .25rem;"><i class="fa-regular fa-file-code"></i>Source Code</a>
  ...
  async function getRepoList() {
    try {
      const response = await fetch(
        "https://api.github.com/users/bless643//repos"
      );
